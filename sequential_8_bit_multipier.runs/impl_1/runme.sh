...
HD_PWD='C:/Users/youssef3453/sequential_8_bit_multipier/sequential_8_bit_multipier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Scanner.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Scanner.tcl -notrace
