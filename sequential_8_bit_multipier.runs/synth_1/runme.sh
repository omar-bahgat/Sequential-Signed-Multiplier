...
HD_PWD='C:/Users/youssef3453/sequential_8_bit_multipier/sequential_8_bit_multipier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Scanner.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Scanner.tcl
